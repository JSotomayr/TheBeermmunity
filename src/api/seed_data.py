    ...
    "Event" : [
        {
            "id": "1", 
            "name": "Beerfest"
            "description": "¡Ven a nuestro local a probar todas las cervezas posibles y llenar tu carton de BingBeer para ganar estupendos premios!",
            "date": "20/12/2021",
            "country": "España",
            "city": "Madrid",
